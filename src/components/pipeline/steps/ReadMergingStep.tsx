...
const ReadMergingStep: React.FC<ReadMergingStepProps> = ({
  step,
  progress,
}) => {
  ...
  const lengthData = Array.from({ length: 50 }, (_, i) => ({
    ...
    count: Math.max(
      0,
      1000 * Math.exp(-Math.pow(i - 25, 2) / 200) + Math.random() * 100
    ),
  }));
  ...
  const mergeStats = [
    { label: "Total Read Pairs", value: "1,189,432", status: progress > 10 },
    {
      ...
      value: progress > 60 ? "987,654 (83.0%)" : "--",
      status: progress > 60,
    },
    {
      label: "Mean Merged Length",
      value: progress > 80 ? "253 bp" : "--",
      status: progress > 80,
    },
    {
      label: "Overlap Quality",
      value: progress > 90 ? "98.7%" : "--",
      status: progress > 90,
    },
  ];
              ...
              >
                ...
                <span
                  className={`text-sm font-mono ${
                    stat.status ? "text-green-400" : "text-slate-500"
                  }`}
                >
                  {stat.value}
                </span>
      ...
      <div className="bg-slate-700 rounded-lg p-4 mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div
              className={`w-20 h-6 rounded flex items-center justify-center transition-all duration-300 ${
          ...
          <div className="flex justify-between items-center text-xs">
            ...
            <span
              className={`font-mono ${
                progress > 50 ? "text-green-400" : "text-slate-500"
              }`}
            >
